# YOLOv8-medium Config for Inference
# Based on: yolov8_m_640x384.py

default_scope = 'mmyolo'

# Image size
img_scale = (640, 384)  # width x height
pad_val = 114

# YOLOv8-medium parameters
deepen_factor = 0.67
widen_factor = 0.75
...
model = dict(
  ...
  # YOLOv8 CSPDarknet backbone (medium size)
  backbone=dict(
